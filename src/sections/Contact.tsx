...
const Contact: React.FC = () => {
  ...
  const email = "indrasuthar14@gmail.com";
    ...
    <footer id="contact" className="min-h-screen pt-32 pb-12 px-8 md:px-16 bg-[#0a0a0a] relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="space-y-12">
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-white/60">Jodhpur, Rajasthan / Worldwide</p>
                </div>
                <div>
                  <p className="mono text-[10px] uppercase tracking-widest text-white/30 mb-4">Contact</p>
                  <div className="flex flex-col space-y-2">
                    <a href="tel:+919351432296" className="text-white/60 hover:text-teal-400 transition-colors interactive">+91 9351432296</a>
                    <a href="mailto:indrasuthar14@gmail.com" className="text-white/60 hover:text-teal-400 transition-colors interactive">Email</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="mt-32 border-t border-white/5 pt-12 relative">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 text-center md:text-left">
          <div className="mono text-[10px] text-white/20 uppercase tracking-widest">© 2025 Indra Suthar</div>
          ...
          <div className="flex space-x-12 mono text-[10px] text-white/40">
             <a href="https://github.com/indrasuthar07" target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 interactive transition-colors uppercase">GITHUB</a>
             <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 interactive transition-colors uppercase">LINKEDIN</a>
             <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 interactive transition-colors uppercase">TWITTER</a>
          </div>
        </div>
      </div>
    </footer>
